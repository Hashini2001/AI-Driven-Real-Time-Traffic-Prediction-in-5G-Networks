...
MODEL_SAVE_PATH = "C:/Users/kdhas/Desktop/Research New/models/new models/new/new_catboost_model.pkl"
WINDOW_SIZE = 10
...
base_model = CatBoostRegressor(
    ...
    random_seed=42,
    verbose=100,
    task_type='GPU' if os.name != 'nt' and os.system("nvidia-smi") == 0 else 'CPU'
)

cat_model = MultiOutputRegressor(base_model)
...
# ------------------------- Final Results -------------------------
evaluate_and_plot(cat_model, X_train, y_train, "Train")
evaluate_and_plot(cat_model, X_val, y_val, "Validation")
